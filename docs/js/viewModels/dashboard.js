define(["require", "exports", "../accUtils", "knockout", "ojs/ojarraydataprovider", "ojs/ojselectcombobox"], function (require, exports, AccUtils, ko, ArrayDataProvider) {
    "use strict";
    class DashboardViewModel {
        constructor() {
            ...
            const listOfMoreInfoPerItemName = {
                ...
                "gdp": createServiceCaller("/api/v1/gdp-growth-rate"),
            };
            self.moreInfoIndicator = (economy, target) => {
